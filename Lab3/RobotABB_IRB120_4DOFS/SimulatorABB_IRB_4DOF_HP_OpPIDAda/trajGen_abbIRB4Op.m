...
elseif((t>=t3)&&(t<t4)) % Crown fast
    ...
    xdpp_0(1,1)= -r * w^2 * cos(w * td);
    xdpp_0(2,1)= -r * w^2 * sin(w * td);
    xdpp_0(3,1)= -2 * r2 * w2^2 * sin(w2 * td);
